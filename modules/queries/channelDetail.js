...
module.exports = function (channel, token, cb) {
    ...
    var endDate = new Date(),
        ...
        url = "https://www.googleapis.com/youtube/analytics/v1/reports?ids=contentOwner%3D%3Dthreehundred&start-date=" + start + "&end-date=" + end + "&metrics=views%2CestimatedMinutesWatched%2CaverageViewDuration%2CaverageViewPercentage%2CsubscribersGained&dimensions=day&filters=channel%3D%3D" + channel + "&sort=day&access_token=" + token,
